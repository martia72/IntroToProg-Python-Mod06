...
#   Andrea Martinez,11/19/24,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class FileProcessor:
    ...
    Andrea Martinez,11/20/24,Created Class
    """
    ...
    def write_data_to_file(file_name: str, student_data: list):
        """ This function writes data in the form of dictionary rowns to a JSON file and saves it
...
class IO:
    ...
    def output_error_messages(message: str, error: Exception = None):
        ...
        ChangeLog: (Who, When, What)
        Andrea Martinez, 11/2024, Created function
    ...
    def input_student_data(student_data: list):
        """ This function gets the student's first name, last name, and course registration
        ...
        return student_data #Needed to give back data instead of empty
